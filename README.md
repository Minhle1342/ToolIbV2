...
- **Hỗ trợ cấu trúc thư mục linh hoạt**: Hỗ trợ nạp dataset có cấu trúc thư mục phẳng (flat) hoặc cấu trúc thư mục chuẩn YOLO (`images/train/`, `labels/train/`) một cách tự động khi khởi tạo dự án.
