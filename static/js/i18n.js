const translations = {
    en: {
        ...
        "filter_by_tag_view": "Show by Tag",
        ...
        "cancel": "Cancel",
        "tag_filter_active": "Tag filter active",
        "tag_filter_edit": "Edit",
        "tag_filter_clear": "Clear",
        "tag_filter_apply": "Apply filter",
        "tag_filter_description": "Choose one or more tags to filter images.",
        "no_tags_in_project": "No tags found in this project.",
        ...
        "dashboard_mergeProjects": "Create / Merge Project",
        "dashboard_mergeProjectsTitle": "Create / Merge Project",
        "dashboard_selectSourceProjects": "Select Source Projects (Min 1)",
        "dashboard_mergeScope": "Source scope",
        "dashboard_mergeScopeAll": "All images",
        "dashboard_mergeScopeTags": "Only images matching tags",
        "dashboard_mergeTagRule": "Matching rule: image has any selected tag.",
        "dashboard_mergeFilteredByTags": "Filtered by tags",
        "dashboard_mergeLoadTagsHint": "Select tag mode to load tags.",
        "dashboard_mergeLoadingTags": "Loading tags...",
        "dashboard_mergeNoTags": "This project has no tags.",
        "dashboard_mergeChooseTags": "Choose at least one tag for every filtered source.",
        "dashboard_mergeTagsPrefix": "Tags",
        "dashboard_mergeOfImages": "of",
        ...
        "dashboard_btnMerge": "Create Project"
    },
    vi: {
        ...
        "dashboard_mergeProjects": "Tạo / Gộp Dự án",
        "dashboard_mergeProjectsTitle": "Tạo / Gộp Dự án",
        "dashboard_selectSourceProjects": "Chọn các dự án nguồn (Chọn tối thiểu 1)",
        "dashboard_mergeScope": "Phạm vi lấy ảnh",
        "dashboard_mergeScopeAll": "Toàn bộ ảnh",
        "dashboard_mergeScopeTags": "Chỉ lấy ảnh theo tag",
        "dashboard_mergeTagRule": "Quy tắc: ảnh có ít nhất một tag đã chọn.",
        "dashboard_mergeFilteredByTags": "Lọc theo tag",
        "dashboard_mergeLoadTagsHint": "Chọn chế độ tag để tải danh sách tag.",
        "dashboard_mergeLoadingTags": "Đang tải tag...",
        "dashboard_mergeNoTags": "Project này chưa có tag.",
        "dashboard_mergeChooseTags": "Hãy chọn ít nhất một tag cho mỗi project đang lọc theo tag.",
        "dashboard_mergeTagsPrefix": "Tag",
        "dashboard_mergeOfImages": "trên",
        ...
        "dashboard_btnMerge": "Tạo Dự án Mới"
    }
};
